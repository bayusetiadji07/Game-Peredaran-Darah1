...
export default function Scene5Interrogation() {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full min-h-screen pt-32 md:pt-40 pb-32 px-6 flex flex-col md:flex-row items-center md:items-end justify-center gap-4 md:gap-10 z-10">
